# 边狱巴士 第十章 第一周 汉化分享（知识库仓库）

> ## 🎮 只是想装汉化？请去这里 →
> ## <https://github.com/haool871/limbus-zh-10ch>
>
> 本仓库是**翻译知识库**（术语、流程、工具、审计说明），主要给翻译者看。
> 汉化补丁的**下载与安装说明**已迁到上面那个发布仓库。
> 本仓库里的 `patch/` 是**上一轮历史交付物**，不再更新，请勿再拿它安装。
